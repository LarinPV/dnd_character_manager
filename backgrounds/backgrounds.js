...
const backgroundData = {
    ...
    "Агент Дома": {
        money: { cp: "", sp: "", ep: "", gp: "15", pp: "" },
        equip: "Перстень Дома, дорожная одежда, 15 зм",
        feature: "Связи Дома: Вы можете получать помощь от вашего дракононосного Дома.",
        profs: () => "Навыки: Расследование, Убеждение.\nИнструменты: Инструменты, связанные с Домом."
    },
    "Преследуемый": {
        money: { cp: "", sp: "", ep: "", gp: "1", pp: "" },
        equip: "Набор охотника на монстров, 1 зм",
        feature: "Сердце тьмы: Те, кто смотрят вам в глаза, видят тьму и испытывают сочувствие или страх.",
        profs: () => "Навыки: Расследование, Выживание.\nЯзыки: Один экзотический."
    },
    "Сыщик": {
        money: { cp: "", sp: "", ep: "", gp: "15", pp: "" },
        equip: "Лупа, блокнот, обычная одежда, 15 зм",
        feature: "Острый глаз: Вы легко замечаете улики там, где другие ничего не видят.",
        profs: () => "Навыки: Расследование, Проницательность.\nИнструменты: Воровские инструменты или Инструменты жестянщика."
    }
};